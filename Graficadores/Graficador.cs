...
namespace GameCompiler.Graficadores
{
    public class Graficador
    {
        ...
        public void graficar(ParseTree arbol)
        {
            ...
            contador = 0;
            String rdot = desktop + "\\Proyecto1Reportes\\Arbol\\arbol.dot";
            String rpng = desktop + "\\Proyecto1Reportes\\Arbol\\arbol.png";
        ...
        public void GraficarFlujo()
        {
            ...
            String rdot = desktop + "\\Proyecto1Reportes\\Arbol\\flujo.dot";
            String rpng = desktop + "\\Proyecto1Reportes\\Arbol\\flujo.png";
